---
title: 'klay_syncing'
description: 'Returns false when the node is fully synced, otherwise returns an object describing sync progress.'
---
### Parameters
  ...
  <ParamField body='method' type='string' default='klay_syncing' required>
