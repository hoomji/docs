---
title: 'arbtrace_call'
description: 'Simulates a message call and returns detailed traces, such as VM execution trace, state diffs, and basic call traces. Supported only on OpenEthereum and Erigon with trace mode enabled (for blocks &lt; 22207816).'
---
### Parameters
