...
description: 'Replays a transaction identified by its hash and returns traces of its execution. Supported only on OpenEthereum and Erigon (trace mode required) for blocks prior to 22207816.'
---
### Parameters
