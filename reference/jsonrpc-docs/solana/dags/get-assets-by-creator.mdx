...
description: 'Retrieves a list of compressed or standard Solana assets created by the given creator address. Requires Solana DAS API add-on.'
...
### Parameters
  ...
  <ParamField body='method' type='string' default='getAssetsByCreator' required>
    JSON-RPC method name.
  </ParamField>

<ParamField body='params' type='object' default={{"creatorAddress":"7zL7HVn85F5yFT6XM3BsJcQF7PBcNE7R2BT5GyfunpKe","limit":10}} placeholder='{"creatorAddress":"7zL7HVn85F5yFT6XM3BsJcQF7PBcNE7R2BT5GyfunpKe","limit":10}' required>
