...
description: 'Retrieves the list of compressed or standard Solana assets controlled by a given authority address. Requires Solana DAS API add-on.'
...
### Parameters
  ...
  <ParamField body='method' type='string' default='getAssetsByAuthority' required>
    JSON-RPC method name.
  </ParamField>

<ParamField body='params' type='object' default={{"authorityAddress":"mdaoxg4DVGptU4WSpzGyVpK3zqsgn7Qzx5XNgWTcEA2","limit":10}} placeholder='{"authorityAddress":"mdaoxg4DVGptU4WSpzGyVpK3zqsgn7Qzx5XNgWTcEA2","limit":10}' required>
