...
description: 'Returns execution traces matching the specified filter. Useful for querying specific address interactions or block ranges. Requires trace mode on OpenEthereum or Erigon, and is only supported for blocks before 22207816.'
---
### Parameters
