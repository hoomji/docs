...
description: 'Replays all transactions in a given block and returns execution traces for each transaction. Supported only on OpenEthereum and Erigon (trace mode required) for blocks prior to 22207816.'
---
### Parameters
