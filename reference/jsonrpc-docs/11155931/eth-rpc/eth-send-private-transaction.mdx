...
description: 'Sends a signed transaction to a private relay (like Flashbots Protect) for inclusion in a block without exposure to the public mempool. Provides frontrunning and revert protection.'
---
### Parameters
