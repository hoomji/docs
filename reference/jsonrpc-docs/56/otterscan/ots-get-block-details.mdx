...
description: 'Given a block number, return its data. Similar to the standard eth_getBlockByNumber/Hash method, but optimized.'
...
### Parameters
  ...
  <ParamField body='method' type='string' default='ots_getBlockDetails' required>
